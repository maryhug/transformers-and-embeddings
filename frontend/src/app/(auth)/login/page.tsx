 ...
 * Muestra el formulario de login con fondo de ondas animadas.
 */
...
/**
 * Página de login con diseño glassmorphism centrado.
 */
export default function LoginPage(): React.JSX.Element {
  ...
  return (
    <>
      <WaveBackground />
      <div className="page-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', minHeight: '100vh' }}>
